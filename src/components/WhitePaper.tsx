    ...
    <section ref={sectionRef} className="py-20 bg-gradient-to-b from-gray-800 via-gray-900 to-gray-800">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <Card className={`transition-all duration-1000 delay-200 bg-gray-800/50 backdrop-blur-sm border border-white/10 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <CardHeader className="text-center pb-6">
              <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-4">
                <Zap className="w-8 h-8 text-white" />
              </div>
              <div className="text-sm text-gray-400 mb-2">AutoPromptr White Paper</div>
              <CardTitle className="text-2xl mb-2 text-white">AI Prompt Engineering Best Practices</CardTitle>
          ...
          <Card className={`transition-all duration-1000 delay-400 bg-gray-800/50 backdrop-blur-sm border border-white/10 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <CardHeader className="text-center pb-6">
              ...
              <CardTitle className="text-2xl mb-2 text-white">Streamlining Development Workflows</CardTitle>
              <CardDescription className="text-base text-gray-300">
