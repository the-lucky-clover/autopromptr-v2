...
const HeroContent = ({ onSignInClick }: HeroContentProps) => {
  ...
  return (
    <div className="text-center mb-12 pt-24 sm:pt-28 lg:pt-32">
      {/* Two-line hero headline with proper spacing and gradient only on "Supercharge Your" */}
      <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold mb-8 leading-[1.1] font-sans">
